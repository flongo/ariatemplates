...
module.exports = function (grunt) {
    ...
    grunt.config.set('packaging.license', grunt.file.read(path.join(__dirname, '../../templates/LICENSE')));
    grunt.config.set('packaging.license_min', grunt.file.read(path.join(__dirname, '../../templates/LICENSE-MIN')));
